...
const translations = {
  es: {
    ...
    'benefits.mvp-validation': 'posibilidad de validación de MVPs en entornos reales',
  ...
  ca: {
    ...
    'benefits.mvp-validation': 'possibilitat de validació de MVPs en entorns reals',
